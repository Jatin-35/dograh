...
description: "Connect BotrixAI AI with external services and platforms"
---

## Introduction

BotrixAI AI provides a flexible integration architecture that allows you to connect with various external services and platforms. Our integration system is designed with modularity and extensibility in mind, making it easy to add new providers while maintaining backward compatibility.
...
- Visit our [GitHub Issues](https://www.botrixai.com/contact) for community support
- Join our [Slack community](https://www.botrixai.com/contact) for assistance