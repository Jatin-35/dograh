---
title: "Prerequisites"
description: "System requirements and setup needed to run BotrixAI AI locally"
---
...
To run BotrixAI AI locally, make sure you have the following installed:
...
BotrixAI images are available from two registries:

- **GitHub Container Registry (Default)**: `ghcr.io/jatin-35` - Recommended for most users
...
REGISTRY=ghcr.io/jatin-35 ./start_docker.sh
...
```powershell Windows
# Using GitHub Container Registry (recommended)
$env:REGISTRY = 'ghcr.io/jatin-35'; .\start_docker.ps1
