---
title: "Introduction"
description: "Build and operate BotrixAI voice AI agents programmatically from Python or TypeScript"
---

BotrixAI ships official SDKs for **Python** and **TypeScript** that wrap the BotrixAI REST API and the workflow builder. Use them to create or edit agents, place outbound calls, and inspect runs from your own code.

- **Python** — [`botrixai-sdk`](https://pypi.org/project/dograh-sdk/) on PyPI
...
Generate an API key at [`/api-keys`](https://voice-app.botrixai.com/api-keys) (or `http://localhost:3010/api-keys` for self-hosted). See [API Keys](/configurations/api-keys) for details.
...
client = DograhClient(
    base_url="https://voice-app.botrixai.com",
...
const client = new DograhClient({
    baseUrl: "https://voice-app.botrixai.com",
    apiKey: "YOUR_API_KEY",
});
```
</CodeGroup>
