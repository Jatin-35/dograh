...
description: "How to authenticate requests to the BotrixAI API"
---
...
```bash
curl https://your-botrixai-instance/api/v1/workflow/fetch \
...
<Note>
Sign in to the dashboard, then create an API key there before making API calls.
</Note>
