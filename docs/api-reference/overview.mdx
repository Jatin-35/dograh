---
title: "Overview"
description: "Interact with BotrixAI programmatically via the REST API"
---
...
```
https://your-botrixai-instance/api/v1
```

If you are using the hosted version, the base URL is `https://voice-app.botrixai.com/api/v1`.
...
```bash
curl -X POST https://your-botrixai-instance/api/v1/workflow/create/definition \
...
```bash
curl https://your-botrixai-instance/api/v1/health
```
...
```json
{
  "status": "ok",
  "version": "1.0.0",
  "backend_api_endpoint": "https://your-botrixai-instance",
  "deployment_mode": "oss",
  "auth_provider": "local"
}
```
