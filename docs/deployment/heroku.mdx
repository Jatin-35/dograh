...
description: "One-click deployment of BotrixAI AI to Heroku cloud platform"
---

Deploy BotrixAI AI to Heroku with a single click for instant cloud hosting.

## What is Heroku Deployment?

Heroku deployment provides a one-click solution to deploy BotrixAI AI to the cloud without managing servers or infrastructure. Perfect for:

- **Quick Testing**: Get a cloud instance running in minutes
- **Small Teams**: Cost-effective solution for lightweight usage
- **Proof of Concept**: Demonstrate BotrixAI AI to stakeholders quickly
...
- Pre-configured BotrixAI AI application
...
For updates on Heroku deployment availability, please [join our Slack community](https://www.botrixai.com/contact) or watch our GitHub repository for announcements.