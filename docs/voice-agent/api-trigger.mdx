...
The id is shown on each row in **Telephony configurations**. The configuration must belong to the same organization as the API Trigger; otherwise the request returns `404`.
