...
<Tip>
**Using Claude Code or Codex?** Install the [BotrixAI setup skill](https://github.com/dograh-hq/dograh-plugins) (`/plugin marketplace add dograh-hq/dograh-plugins`, then `/plugin install botrixai@botrixai`) and ask your agent to *"set up BotrixAI for development"* — it runs the steps below for you and verifies the stack is healthy.
</Tip>
