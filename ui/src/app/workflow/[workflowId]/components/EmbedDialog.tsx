                ...
                const response = await createOrUpdateEmbedTokenApiV1WorkflowWorkflowIdEmbedTokenPost({
                    ...
                    body: {
                        ...
                        settings: {
                            ...
                            size: "medium",
                            autoStart: false,
                            containerId: embedMode === "inline" ? "botrixai-inline-container" : undefined,
                        },
                        usage_limit: null,
                                        ...
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                ...
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    ...
                                                    <li>• Call <code className="text-xs">window.BotrixAIWidget.start()</code> to begin a call.</li>
                                                    <li>• Call <code className="text-xs">window.BotrixAIWidget.end()</code> to end it.</li>
...
document.getElementById('talk-btn').addEventListener('click', () => {
  ...
  return (
    <button onClick={() => isLive ? window.BotrixAIWidget.end() : window.BotrixAIWidget.start()}>
                                    ...
                                    {embedMode === "inline" && (
                                        <div className="space-y-3">
                                            <div className="rounded-lg bg-muted/50 p-4">
                                                <h4 className="font-medium mb-2">Integration Instructions</h4>
                                                <ul className="text-sm space-y-2 text-muted-foreground">
                                                    <li>• Add a div with id=&quot;botrixai-inline-container&quot; where you want the widget</li>
                                                    <li>• The widget will render inside this container</li>
                                                    <li>• You have full control over the container&apos;s styling</li>
                                                    <li>• Call window.BotrixAIWidget.start() to begin the call</li>
                                                    <li>• Call window.BotrixAIWidget.end() to end the call</li>
                                                </ul>
                                            </div>
  ...
  useEffect(() => {
    ...
    window.BotrixAIWidget?.onCallStart(() => {
      setIsCallActive(true);
    });
    window.BotrixAIWidget?.onCallEnd(() => {
  ...
  return (
    <div className="my-8">
      ...
      <div id="botrixai-inline-container" className="min-h-[400px]">
        {/* Widget renders here */}
      </div>
      <button
        onClick={() => window.BotrixAIWidget?.start()}
